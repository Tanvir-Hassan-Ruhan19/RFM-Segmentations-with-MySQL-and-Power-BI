...
DATEDIFF((SELECT MAX(STR_TO_DATE(ORDERDATE, '%d/%m/%y')) FROM SAMPLE_SALES_DATA), -- subquari sobar age run hoy 
MAX(STR_TO_DATE(ORDERDATE, '%d/%m/%y'))) AS CUSTOMER_RECENCY
FROM SAMPLE_SALES_DATA
group by CUSTOMERNAME;

SELECT MAX(STR_TO_DATE(ORDERDATE,'%d/%m/%y'))FROM SAMPLE_SALES_DATA; -- [Last Business day]
SELECT MIN(STR_TO_DATE(ORDERDATE,'%d/%m/%y')) FROM SAMPLE_SALES_DATA; 
